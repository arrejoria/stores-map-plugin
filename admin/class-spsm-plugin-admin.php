			...
			<div class=" modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						?>
						<form action="" id="updateSucursalForm">
							<input type="hidden" id="sucursalId" value="">
							<input type="text" value="tesing ajax" name="testing">
							<input type="submit" value="enviar" >
						</form>

						
					</div>
					<!-- <form class="modal-body p-2" id="modalContent">
						<fieldset>
							<legend>Datos de la sucursal</legend>
							<div class="flex max-md:flex-col w-full">
								<div class="mb-3">
									<label for="nombre">Nombre</label>
									<input type="text" name="edit_nombre" value="" id="editNombre">
								</div>
								<div class="mb-3">
									<label for="local">Local</label>
									<input type="text" name="edit_local" value="" id="editLocal">
								</div>
							</div>

							<div class="mb-3">
								<label for="direccion">Direccion</label>
								<input type="text" name="edit_direccion" value="" id="editDireccion">
							</div>

							<div class="flex max-md:flex-col w-full">
								<div class="mb-3">
									<label for="localidad">Localidad</label>
									<input type="text" name="edit_localidad" value="" id="editLocalidad">
								</div>
								<div class="mb-3">
									<label for="zona">Zona</label>
									<input type="text" name="edit_zona" value="" id="editZona">
								</div>
							</div>
							<div class="mb-3">
								<label for="descripcion">Descripcion</label>
								<textarea name="edit_descripcion" id="editDescripcion"></textarea>
							</div>
						</fieldset>

						<input type="submit" value="Actualizar datos" id="updateSucursal">
					</form> -->
				</div>
			</div>
		</div>
