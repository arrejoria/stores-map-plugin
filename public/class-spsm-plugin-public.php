...
<div class="w-full px-2 smsp mb-[100px] space-y-3" id="mapContainer">
    <h1 class="text-2xl font-semibold text-center mb-12 text-primary-color">Podes buscar las sucursales que tenemos por
        tu zona:</h1>
    <div class="flex flex-col items-center justify-center gap-2 md:flex-row w-full md:max-w-full border rounded md:rounded-full md:gap-x-3 border-gray-400 py-3 px-1 md:px-5 mx-auto !mb-7"
        id="storesFilters">
    ...
    <div class="grid grid-cols-1 md:grid-cols-7 xl:grid-cols-12 w-full md:border gap-y-3">
        <div class="stores-content col-span-1 md:col-span-3 xl:col-span-4 relative border shadow">
